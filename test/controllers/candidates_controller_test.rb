...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { name: @candidate.name, party: @candidate.party, title: @candidate.title } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { name: @candidate.name, party: @candidate.party, title: @candidate.title } }
